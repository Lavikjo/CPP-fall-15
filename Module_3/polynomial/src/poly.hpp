...
class Poly {
    ...
    public:
        ...
        const_iterator begin() const {return( m_values.crbegin() );}
        const_iterator end() const {return( m_values.crend() );}
        iterator begin() {return m_values.rbegin();}
        iterator end() {return m_values.rend();}
